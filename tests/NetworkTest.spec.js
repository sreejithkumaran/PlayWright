...
test("Place Order", async ({ page }) => {
  ...
  // intercepting response - API response  -> { Playwright fakeresponse} -> broswer -> Render data on Front End
  await page.route(
    "https://rahulshettyacademy.com/api/ecom/order/get-orders-for-customerhttps://rahulshettyacademy.com/api/ecom/order/get-orders-details?id=64a4dbd97244490f95755f3a",
    async route => {
